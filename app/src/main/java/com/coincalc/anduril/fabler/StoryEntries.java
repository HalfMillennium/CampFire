...
public class StoryEntries extends AppCompatActivity {
    ...
    public void checkViews(final String storyName)
    {
        ...
        ref.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                String user = dataSnapshot.child("stories").child(storyName).child("user").getValue(String.class);
                String username = dataSnapshot.child("users").child(email).getValue(String.class);
    ...
    public static void addView(String storyName)
    {
        DatabaseReference base = FirebaseDatabase.getInstance().getReference();
        final DatabaseReference ref = base.child("stories").child(storyName).child("views");

        base.child("stories").child(storyName).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                int currViews = Integer.parseInt(dataSnapshot.child("views").getValue(String.class));
                currViews++;

                ref.setValue("" + currViews);
                ref.push();
            }
